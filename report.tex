...
\usepackage{biblatex} % used to add bibliography
...
\setlength{\cftbeforelottitleskip}{0pt plus 1pt} % sets the space before the list of tables to match sections
    ...
    \section{Introduction}
        ...
        DDoS attack has different types depending on the infrastructure it targets and the vulnerabilities it exploits %TODO: add vulnerabilities and types of DDoS attacks
